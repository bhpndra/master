		...
		<div class="row">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">BBPS Report</h3>
            </div>
            <!-- /.card-header -->
			<div class="card-body">
<?php
...
<?php
$circle_url = BASE_URL."/api/bbps/report.php";
...
?>
				...
				<tr>
				  ...
				  ?>
				  <td><span class="badge badge-<?=$badge?>"><?=$row['status']?></span> <a href="invoice-print?trans_id=<?=$row['agent_trid']?>&invoice_type=BBPS" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize'); return false;"><i class="fas fa-print"></i></a><br>
