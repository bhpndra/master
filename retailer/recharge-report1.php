...
?>
				...
				<tr>
				  ...
				  ?>
				  <td><span class="badge badge-<?=$badge?>"><?=$row['status']?></span> <a href="invoice-print?trans_id=<?=$row['agent_trid']?>&invoice_type=RECHARGE" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize'); return false;"><i class="fas fa-print"></i></a></td>
