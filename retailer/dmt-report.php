...
?>
				...
				<tr>
				  ...
				  ?>
				  <td><span class="badge badge-<?=$badge?>"><?=$row['status']?></span> <a href="invoice-print?trans_id=<?=$row['agent_trid']?>&invoice_type=DMT" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=SomeSize,height=SomeSize'); return false;"><i class="fas fa-print"></i></a><br>
					<a href="javascript:void()" class="badge badge-dark" onclick="raise_dispute('<?=$row["agent_trid"]?>');">Raise Dispute</a>
