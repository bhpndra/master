			  ...
			  <div class="card card-warning">
				...
				<div class="card-body row">
				  <div class="form-group col-md-4">
					...
					<input type="password"  class="form-control" value="" maxlength="4"  pattern="[0-9]+" name="o_pin" required >
				  </div>
				  <div class="form-group col-md-4">
					<label for="inputName">Pin</label>
					<input type="password"  class="form-control" value="" pattern="[0-9]+" name="npin" id="npin" maxlength="4" required >
				  </div>
				  <div class="form-group col-md-4">
					<label for="inputName">Confirm Pin</label>
					<input type="password"  class="form-control" value="" pattern="[0-9]+" onblur="checkPin(this)" maxlength="4" required >
				  </div>
