...
$circle_url = BASE_URL."/api/recharge/get_circle.php";
...
if($resRC['ERROR_CODE']==0){
	$circle = "<option value='' selected>Select Circle</option>";
	foreach($resRC['CIRCLE'] as $rc){
		$circle .= "<option value='".$rc['circle_id']."'>".$rc['circle_name']."</option>";
	}
	echo $circle;
} else {
