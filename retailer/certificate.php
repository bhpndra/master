...
<style>
	...
	<tr>
		<td class="header">
			$logo
			<p class="heading"><strong>Certificate of Business Correspondent Agent</strong></p>
		</td>
	</tr>
	<tr>
		<td>
...
Has been appointed as Registered User of $cname for Providing Essential Service Such As AEPS through $cname Portal ($domain)
