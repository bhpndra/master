...
{
     $sql1 = "select id from add_cust where pan_no='".$array['pan_no']."'";
    ...
    ('".$id['id']."', '".$array['outletid']."','". $array['first_name']."','".$array['last_name']."', '".$array['middle_name']."','". $array['email']."','".$array['mobile']."','".$array['company']."', '".$array['address']."','".$array['pincode']."','".$array['city']."', '".$array['state']."', '".$array['district']."','".$array['pan_no']."', '".$array['registration_date']."','".$array['outlet_status']."', '".$array['outlet_kyc']."','".$array['dob']."', '".$array['panimg']."', '".$array['aadhaar']."','".$array['status']."' )";
         }
     }
