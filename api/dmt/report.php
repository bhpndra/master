...
***************/
	...
	if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST)){
		...
		$filter .= (isset($post['mobile']) && $post['mobile'] != '') ? " and mobile = '".$post['mobile']."'" : '';
		...
		$columns = "id, transaction_id, agent_trid, mobile, ref_no, amount, deducted_amount, bene_code, bene_name, bene_ac, ifsc_code, txn_group_id, date_created, status";
		$res = $mysqlClass->fetchAllData('dmt_info', $columns, " where user_id = '".$USER_ID."' ".$filter.$orderBy.$pagin );
