...
***************/
	...
	if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST)){
		...
		//// Call netpaisa_curl ////
		$request_param = ['api_access_key' => $api_access_key,'remitterid'=>$remitterid,'beneficiaryid'=>$beneficiaryid];

		$res_json = $helpers->netpaisa_curl($beneficiary_remove, $request_param);
