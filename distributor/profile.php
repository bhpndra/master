			  ...
			  <div class="card card-warning">
				...
				<div class="card-body row">
				  <div class="form-group col-md-4">
					...
					<input type="password"  class="form-control" maxlength="4" value=""  name="o_pin" required >
				  </div>
				  <div class="form-group col-md-4">
					<label for="inputName">Pin</label>
					<input type="password"  class="form-control" maxlength="4" pattern="[0-9]+" value="" name="npin" id="npin" required >
				  </div>
				  <div class="form-group col-md-4">
					<label for="inputName">Confirm Pin</label>
					<input type="password"  class="form-control" maxlength="4" pattern="[0-9]+" value=""  onblur="checkPin(this)" required >
				  </div>
