                                            ...
                                            <div class="portlet box blue">
												...
												?>					
															...
															<div class="form-group col-md-3">
																...
																<div>
																	<input type="submit" id="" name="filter" value="Filter" class="btn btn-primary"> <a href="aeps-wallet-withdrawl.php" class="btn btn-default">Reset</a>
																</div>
															</div>
														</form>
												</div>
...
$sql = "SELECT 
		...
		where 1 and awi.user_id = u.id and awi.withdrawl_type = 'WALLET' and u.admin_id = '".$_SESSION[_session_userid_]."'";	
 ...
 $i = $pagination['offset'] + 1;
			...
			?>
									<tr>
										...
										<td><?php echo $rows["withdrawl_type"]; ?></td>
										<td><?php echo $rows["transaction_id"]; ?></td>
										<td><?php echo $rows["amount"]; ?></td>
										<td><?php echo $rows['payment_date']; ?></td>
										<td>
											<?php echo $rows['status']; ?>
											<?php /* ?><select data-rowId="<?php echo $rows['id'];?>" onchange="updateStatus(this)">
												<option <?php echo ($rows['status']=="PENDING")? "selected": "" ;?> value="PENDING">Pending</option>
												<option <?php echo ($rows['status']=="APPROVED")? "selected": "";?> value="APPROVED">Approve</option>
