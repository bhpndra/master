                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                       <i class="fa fa-cogs"></i>Distributor Transactions
                                                   </div>
                                                </div>
                                                <div class="portlet-body">
...
$sql = "select a.name, a.user, a.mobile,a.cname,r.* from distributor_trans r INNER JOIN add_cust a  ON r.dist_id=a.id  where 1 and a.admin_id = '".$_SESSION[_session_userid_]."' ";	
