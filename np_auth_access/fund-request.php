                                                        ...
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" width="90px;">Approve</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
<?php
...
?>	
										...
										<td id="action<?= $rows['id']; ?>" colspan="2">
											<?php if($rows['status']=="PENDING") { ?>
													<a href="javascript:void(0)" onclick="fund_cancel('<?= $rows['id']; ?>')" class="btn btn-warning btn-xs statusmsg" style="margin-bottom:5px;" >Decline</a>
													&nbsp; &nbsp; &nbsp; 
													<!--<a href="javascript:void(0)" onclick="fund_approve('<?= $rows['id']; ?>','<?= $rows['amount']; ?>')" class="btn btn-primary btn-xs statusmsg push-right" >Approve</a>-->
													<a href="javascript:void(0)" onclick="fund_approve_referenceid('<?= $rows['id']; ?>')" class="btn btn-primary btn-xs statusmsg push-right" >Enter ReferenceId & Approve</a>
											<?php } ?>
										</td>
										<?php $i++; } ?>
									</tr>
