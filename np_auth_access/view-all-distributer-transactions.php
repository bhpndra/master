...
<?php
	...
	if($filterBy['dateFrom']=="" && $filterBy['dateTo']==""){
		$date1 = new DateTime('90 days ago');
                                        ...
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
												...
												?>
																...
																<?php
																	$trType = $mysqlObj->mysqlQuery("SELECT DISTINCT tr_type FROM `distributor_trans` where tr_type != '' 
ORDER BY `tr_type` ASC");
															...
															<div class="form-group col-md-2">
																...
																<div>
																	<input type="submit" id="" name="filter" value="Filter" class="btn btn-primary"> <a href="view-all-distributer-transactions.php?uid=<?=$_GET['uid']?>" class="btn btn-default">Reset</a>
																</div>
															</div>
														</form>
												</div>
...
$sql = "SELECT * FROM `distributor_trans` where 1 and `dist_id`='".$filterBy['uid']."'  ";	
 ...
 $i = $pagination['offset'] + 1;
			...
			?>
									<tr>
										...
										<?php
											$opbl = $userClass->check_transaction_openingBalance($rows['dist_id'],$rows['id'],"distributer");
