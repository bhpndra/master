                        ...
                        <div class="page-content">
                            <div class="container">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <li>
                                        <span>All Software Package Commission</span>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-cogs"></i>Manage Software Package Commission</div>
                                                </div>
...
$sql = "select * from package_list where creator_id = 1 and created_by = 'ADMIN'";
												...
												while ($row = $sqlQuery->fetch(PDO::FETCH_ASSOC)){
													?>
														<tr>
															...
															<td>
																<a href='update-software-package.php?id=<?php echo $row['id']; ?>' class='btn btn-warning left-margin'>
