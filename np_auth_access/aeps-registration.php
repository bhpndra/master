...
<?php
	...
	if(isset($filterBy['fByStatus'])&& $filterBy['fByStatus']!=""){
		$filter .= " and ol.status ='".$filterBy['fByStatus']."' ";
	} 
												...
												?>
																<div>
																	<select class='form-control' name='fByStatus' >
																		...
																		<option <?=@$APPROVE?> value="APPROVE">Approve</option>
															...
															<div class="form-group col-md-3">
																...
																<div>
																	<input type="submit" id="" name="filter" value="Filter" class="btn btn-primary"> <a href="aeps-registration.php" class="btn btn-default">Reset</a>
																</div>
															</div>
														</form>
												</div>
			...
			?>
									<tr>
										...
										<td>
											...
											<strong>Outlet Id : </strong><?php echo $rows["outletid"]; ?>
										...
										<td>
											...
											<select data-rowId="<?php echo $rows['id'];?>" onchange="updateStatus(this)">
												...
												<option <?php echo ($rows['status']=="APPROVE")? "selected": "";?> value="APPROVE">Approve</option>
	...
	$(document).ready(function(){
		...
		function updateStatus(e){
			if(confirm('Are You sure want update ?')){
				...
				$.ajax({
					type: 'POST',
					data: {status:sts, row:id, action:"updateStatus" },
					cache: false,
