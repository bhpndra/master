                                        ...
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
													...
													<div class="actions">
														<a href="recharge-dispute-history.php?status=Open" class="btn btn-<?php echo $statusBtnClass1;?> pull-right">All Open Disputes</a> 
														<a href="recharge-dispute-history.php?status=Closed" class="btn btn-<?php echo $statusBtnClass2;?> pull-right">All Closed Disputes</a> 
													</div>
                                                </div>
...
`disputes` as d,
add_cust as u
where d.user_id = u.id and d.dispute_type = 'Recharge' and d.user_id != '' and u.id != '' ".$statusFilter."
			...
			?>
									<tr>
										...
										<td>
											...
											<strong>Message:<br/> </strong><?php echo $rows["message"]; ?><br/>
										</td>
										...
										<td style="width: 115px;">
											...
											<span style="color:blue">(<?=$helper->create_durations($rows['update_on'])." ago."?>)</span>
										</td>
										<td style="width: 90px;">
											...
											<a class='btn btn-primary btn-xs statusmsg' href='user-recharge-dispute.php?<?php echo "tid=".$rows["transaction_id"]."&uid=".$rows['uid']; ?>' target='_blank'>View Chat</a>
										</td>
										<?php $i++; } ?>
