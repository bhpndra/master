...
<?php
	...
	if(isset($filterBy['fByTranid'])&& $filterBy['fByTranid']!=""){
		$filter .= " and (concat_ws(' ',r.transaction_id,r.agent_trid,r.retailer_id,r.refund_id,r.comments) like '%".$filterBy['fByTranid']."%') ";
	}	
	/* if(isset($filterBy['fByTranid'])&& $filterBy['fByTranid']!=""){
		$filter .= " and r.transaction_id like '%".$filterBy['fByTranid']."%' ";
	} */
                        ...
                        <div class="page-content">
                            <div class="container">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <li>
                                        <span>Retailer Transactions</span>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
												...
												<div class="row">
													<form method="get" >
															<div class="form-group col-md-3">
																...
																<div>
																	<input type='text' id="fByTranid" name='fByTranid' value="<?php echo @$filterBy['fByTranid']; ?>"  class='form-control' placeholder="Search Transaction" >
																</div>
															</div>
															<div class="form-group col-md-3">
																<label>Name</label>
												...
												?>
																...
																<?php
																	$trType = $mysqlObj->mysqlQuery("SELECT DISTINCT tr_type FROM `retailer_trans` where tr_type != '' 
ORDER BY `tr_type` ASC");
															...
															<div class="form-group col-md-3">
																...
																<div>
																	<input type="submit" id="" name="filter" value="Filter" class="btn btn-primary"> <a href="retailer-transaction.php" class="btn btn-default">Reset</a>
																</div>
															</div>
														</form>
													</div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                       <i class="fa fa-cogs"></i>Retailer Transactions
                                                   </div>
                                                </div>
                                                <div class="portlet-body">
...
$sql = "select a.name,a.user,a.mobile,a.cname,r.* from retailer_trans r INNER JOIN add_cust a  ON r.retailer_id=a.id  where 1 and a.admin_id = '".$_SESSION[_session_userid_]."' ";	
