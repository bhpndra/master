                            ...
                            <div class="page-logo">
								<a href="index.php">	
									<? 
										...
										$logo = $mysqlClass->mysqlQuery("select logo,name from `admin` WHERE `id`='".$_SESSION[_session_userid_]."' and `api_access_key`!=''" )->fetch(PDO::FETCH_ASSOC);
										
										//$logourl = BASE_URL."/uploads/logo/".$logo['logo'];
										$logourl = "../uploads/logo/".$logo['logo'];
									?>
									
									<img src="<?=$logourl;?>" alt="<?=$logo['name'];?>" class="logo-default">
								</a>
                            </div>
                        ...
                        <div class="container">
                            <div class="hor-menu  ">
                                <ul class="nav navbar-nav">
									...
									<li class="menu-dropdown classic-menu-dropdown ">
                                        <a href="javascript:;"> <i class="icon-credit-card icons"></i>Reports
											...
											<ul class="dropdown-menu pull-left">
												...
												<li> <a href="aeps-bank-withdrawl.php" class="nav-link">AEPS Bank Withdrawl</a> </li>
												<li> <a href="aeps-wallet-withdrawl.php" class="nav-link">AEPS Wallet Withdrawl</a> </li>
									...
									<li class="menu-dropdown classic-menu-dropdown ">
                                        <a href="javascript:;"> <i class="fa-exclamation-circle fa"></i>Request
                                                <span class="arrow"></span>
                                            </a>
                                        <ul class="dropdown-menu pull-left">
									...
									<li class="menu-dropdown classic-menu-dropdown ">
                                        ...
                                        <ul class="dropdown-menu pull-left">
											...
											<li><a href="admin-bank-details.php" class="nav-link">Bank Details</a></li>
											<li><a href="sms-setting.php" class="nav-link">SMS Setting</a></li>
											<li><a href="update-profile.php" class="nav-link">Profile Update</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
