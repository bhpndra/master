                        ...
                        <div class="page-content">
                            <div class="container">
                                ...
                                <ul class="page-breadcrumb breadcrumb">
                                    ...
                                    <li>
                                        <span>All Fund Debit Statement</span>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                            <div class="portlet box blue">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-cogs"></i>All Fund Debit Statement
                                                    </div>
                                                    <form action="export/fund-debit-statements-excel.php?filter=<?=$filter;?>" method="post">					
                                                        ...
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" width="95px;">Deposits</th>
...
$sql = "SELECT 
			...
			b.usertype,
			b.mobile
		FROM `admin_trans` as a, `add_cust` as b WHERE `tr_type`='CR' and b.id = a.wl_id  and b.admin_id = '".$_SESSION[_session_userid_]."' ";	
//echo $sql.$filter;
