                                            ...
                                            <div class="portlet box blue">
												...
												?>
															...
															<div class="form-group col-md-2">
																...
																<div>
																	<input type="submit" id="" name="filter" value="Filter" class="btn btn-primary"> <a href="view-all-whitelabel-transactions.php?uid=<?=$_GET['uid']?>" class="btn btn-default">Reset</a>
																</div>
															</div>
														</form>
												</div>
...
$sql = "SELECT * FROM `wl_trans` where 1 and `wluser_id`='".$filterBy['uid']."'  ";	
 ...
 $i = $pagination['offset'] + 1;
			...
			?>
									<tr>
										...
										<?php
											$opbl = $userClass->check_transaction_openingBalance($rows['wluser_id'],$rows['id'],"white_label");
