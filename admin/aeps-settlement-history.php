  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">AEPS Settlement History</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">AEPS Settlement History</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
			  ...
			  <div class="card">
				<div class="card-header">
				  <h3 class="card-title">AEPS Settlement History</h3>
				</div>
				<!-- /.card-header -->
...
$sql = " select 
		a.id, a.user_id, a.transaction_id, a.amount, a.status, a.account_number, a.ifsc, a.bank_name, a.group_id, a.payment_date, a.settlement_date
		from wl_aeps_withdrawl as a
		WHERE  a.user_id = '".$WL_ID."' $filter ORDER BY a.id DESC";
