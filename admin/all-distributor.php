...
?>  
          <tr>
            ...
            <td><?=$us['wallet_balance'] ?><br>							
				<a href="distributor-wallet-balance?id=<?= base64_encode($us['id']);?>" target="_blank" class="btn btn-primary btn-xs" title="View Wallet Balance detail"><i class="fa fa-eye" aria-hidden="true"></i> Wallet</a>
			</td>
