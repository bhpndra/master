...
<!-- Select2 -->
<script src="<?=DOMAIN_NAME?>dashboard/plugins/select2/js/select2.full.min.js"></script>
<script src="<?=DOMAIN_NAME?>dashboard/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?=DOMAIN_NAME?>dashboard/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
<!-- SweetAlert2 -->
...
<script src="<?=DOMAIN_NAME?>dashboard/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="<?=DOMAIN_NAME?>dashboard/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
<!-- Bootstrap 4 -->
<script src="<?=DOMAIN_NAME?>dashboard/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<?=DOMAIN_NAME?>dashboard/plugins/chart.js/Chart.min.js"></script>
<!-- AdminLTE App -->
...
$(function () {
	$.ajax({
		...
		{ 
			...
			$("#navVB").html(data.BALANCE.VIRTUAL);
		}
	});
});
