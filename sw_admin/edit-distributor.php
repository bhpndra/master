...
$uid = base64_decode($_GET['uid']);
	...
	if(isset($_POST['update_package'])){		
		...
		if($e_row > 0){
			$e_row = $mysqlClass->updateData(' add_cust ', $value, " where creator_id = '".$uid."' and created_by = 'DISTRIBUTOR' and wl_id = '".$WL_ID."' and usertype = 'RETAILER' ");
			$msg1  = $helpers->alert_message("Package Update Successfully.","alert-success");
		}
	}	
