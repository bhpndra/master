  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">AEPS Wallet Settlement</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">AEPS Wallet Settlement</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
			  ...
			  <div class="card">
				<div class="card-header">
				  <h3 class="card-title">AEPS Wallet Settlement</h3>
				</div>
				<!-- /.card-header -->
...
$sql = " select 
		a.transaction_id, a.amount, a.status, a.account_number, a.account_name, a.ifsc, a.bank_name, a.group_id, a.payment_date, a.settlement_date, b.name, b.user, b.mobile
		from aeps_withdrawl_info as a
		left join add_cust as b on a.user_id = b.id  
		WHERE a.withdrawl_type = 'wallet' and b.wl_id = '".$WL_ID."' $filter ORDER BY a.id DESC";
