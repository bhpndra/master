							...
							<div class="row">								
								<table class="table">	
									...
									<tr>
										...
										<td width="20%"><input type="text" name="cc_value" actocomplete="off" value="<?=$rasPayMode[0]['charge_value']?>" ></td>
										<td>
									...
									<tr>
										...
										<td><input type="text" name="dc_value" actocomplete="off" value="<?=$rasPayMode[1]['charge_value']?>" ></td>
										<td>
									...
									<tr>
										...
										<td><input type="text" name="nb_value" actocomplete="off" value="<?=$rasPayMode[2]['charge_value']?>" ></td>
										<td>
											<select name="nb_stats"  >
									...
									<tr>
										...
										<td><input type="text" name="wal_value" actocomplete="off" value="<?=$rasPayMode[3]['charge_value']?>"></td>
										<td>
											<select name="wal_status"  >
												<option value="ACTIVE" <?if($rasPayMode[3]['status'] == "ACTIVE"){echo "selected";}?>>ACTIVE</option>
												<option value="DEACTIVE" <?if($rasPayMode[3]['status'] == "ACTIVE"){echo "selected";}?>>DEACTIVE</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" name="upi_value" actocomplete="off" value="<?=$rasPayMode[4]['charge_value']?>"  ></td>
										<td>
