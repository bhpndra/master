                                ...
                                <div class="col-md-12 ">
									<form method ="post" class="smart-form" action ="" enctype="multipart/form-data">
										...
										<div class="form-group col-md-4">
											...
											<div>
												<input type='text' name='con_password'  class='form-control' placeholder="Enter Confirm Password">
											</div>
										</div>
...
<?php
	if(isset($_POST['submit']))  {
		...
		if (empty($post['password']) || !isset($post['password'])) {
                     ...
                     echo "<script>alert('Can not empty Password')</script>";
                     unset($_POST);
                     die();
		}
		if (empty($post['con_password']) || !isset($post['con_password'])) {
                   
                     echo "<script>alert('Can not empty confirm Password')</script>";
                     unset($_POST);
                     die();
		}
