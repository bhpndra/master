<?php
	...
	if($post['uid']!="")
	{
		...
		if($mysqlClass->countRows($row)>0)
		{
			...
			echo "<div class='col-md-12 alert alert-success'>WL Permission Updated Successfully.</div>";
			...
			echo "<div class='col-md-12 alert alert-success'>WL Permission Saved Successfully.</div>";
		}	
	}
